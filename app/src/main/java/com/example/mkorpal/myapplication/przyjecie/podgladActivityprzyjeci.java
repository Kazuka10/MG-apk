    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
           ...
           /*    try {
              ...
              //  adapter.notifyDataSetChanged();
                ...
                Cursor data2 = dbHandler.getListContents(); //getItemID - nie wywoluje ale poowinno byc jesli blad
                int itemID = -1;
                ...
                if(itemID > -1){
                  //  Log.d(TAG, "onItemClick: Kliknieto na " + name);
                    ...
                    Toast.makeText(podgladActivityprzyjeci.this, "Nie ma takiego wpisu0", Toast.LENGTH_SHORT).show();
                }
     ...
     /*   recordstextView = (TextView) findViewById(R.id.records);
        ...
        if(data.getCount() == 0) {
            ...
            CharSequence text = "Baza danych jest pusta3";
