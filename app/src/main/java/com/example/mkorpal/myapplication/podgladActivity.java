...
import com.example.mkorpal.myapplication.przyjecie.PrzyjeciestartActivity;

/**
 * Created by m.korpal on 08.09.2016.
 */
public class podgladActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(podgladActivity.this, "Kliknieto przycisk usun", Toast.LENGTH_SHORT).show();
            }
        });
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(podgladActivity.this, "Kliknieto przycisk edytuj", Toast.LENGTH_SHORT).show();
            }
        });
       ...
       // ArrayList<String> theList = new ArrayList<>();
        ...
        if(numRows == 0){
            Toast.makeText(podgladActivity.this, "Baza danch jest pusta", Toast.LENGTH_SHORT).show();
        }
        else{
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
           ...
           /*    try {
              ...
              //  adapter.notifyDataSetChanged();
                ...
                Intent intent = new Intent(podgladActivity.this, WydaniestartActivity.class);
