 ...
 */
public class podgladActivityWypozyczenie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(podgladActivityWypozyczenie.this, "Kliknieto przycisk usun", Toast.LENGTH_SHORT).show();
            }
        });
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(podgladActivityWypozyczenie.this, "Kliknieto przycisk edytuj", Toast.LENGTH_SHORT).show();
            }
        });
       ...
       // ArrayList<String> theList = new ArrayList<>();
        ...
        if(numRows == 0){
            Toast.makeText(podgladActivityWypozyczenie.this, "Baza danch jest pusta", Toast.LENGTH_SHORT).show();
        }
        else{
