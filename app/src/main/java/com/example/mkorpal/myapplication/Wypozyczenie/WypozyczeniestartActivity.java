 ...
 */
public class WypozyczeniestartActivity extends Activity {
    EditText userInput;
    ...
    public void addButtonClicked(View view) {
       ...
       /* String user = userInput.getText().toString();
        ...
        if(product._productname.length() != 0 && product._productkod.length() != 0 && product._productilosc.length() != 0){
            ...
            Toast.makeText(WypozyczeniestartActivity.this, "Musisz podać jakieś wartości",Toast.LENGTH_LONG).show();
